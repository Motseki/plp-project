  ...
  return (
	...
	<div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
	  ...
	  <p className="mb-8 text-lg font-normal text-white lg:text-xl sm:px-16 lg:px-48">
	   An online network for founders and investors to connect, make introductions, seek funding and share advice.
	  </p>
	  <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
		<Link to="/join-us" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
		  Join us
